...
class GauntletSealedScraper():
    ...
    def scrape(self):
        ...
        for product in products:
            ...
            price = product.select_one('div.variant-row').select_one('form.add-to-cart-form')['data-price']
            stock = product.select_one('div.variant-row span.variant-qty').text
